...
readonly LDAP_DOMAIN=compsoc.ie
readonly LDAP_ORGANISATION="CompSoc NUI Galway Test"
readonly LDAP_BINDDN="cn=admin,dc=compsoc,dc=ie"
readonly LDAP_SECRET=EatMyShorts
